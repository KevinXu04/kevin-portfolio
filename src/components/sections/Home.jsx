        ...
        >
            ...
            <div className="text-center z-10 px-4">
                ...
                <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    Welcome to my personal portfolio! Here, you'll find an overview of my skills, 
                    experiences, and ambitions as a student. Curious about my work? Check out the 
                    'Projects' tab to see what I’ve built.
                </p>
